...
public sealed partial class AdminFrozenSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<AdminFrozenComponent, ESSendChatMessageAttemptEvent>(OnInGameOocMessageAttempt);
    }
    ...
    private void OnInGameOocMessageAttempt(Entity<AdminFrozenComponent> ent, ref ESSendChatMessageAttemptEvent args)
    {
        if (!ent.Comp.Muted)
            return;
