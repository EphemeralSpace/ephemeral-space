...
public abstract partial class SharedGunSystem : EntitySystem
{
    ...
    private bool AttemptShoot(EntityUid user, Entity<GunComponent> gun)
    {
        ...
        var gunShakeRotation = new ESScreenshakeParameters() { Trauma = 0.05f * gun.Comp.CameraRecoilScalarModified, DecayRate = 1.2f, Frequency = 0.008f};
        ...
        bool playSound = true)
    {
        ...
        if (angle != null)
        {
            ...
            ThrowingSystem.TryThrow(entity, ejectAngle.ToVec().Normalized() / 100, 5f, doSpin: false);
        }
