...
public sealed partial class ESEmoteSystem : EntitySystem
{
    ...
    private void OnChatMessageSent(Entity<ESEmoteChatChannelComponent> ent, ref ESChatMessageSentEvent args)
    {
        if (ent.Comp.EmoteFromChat)
            TryEmoteChatInput(args.Source, args.Content);
    }
    ...
    /// <param name="hideChat">Whether the message appears in the chat box</param>
    ...
    )
    {
        ...
        return TryEmoteWithChat(source, proto, hideChat: hideChat, hideLog: hideLog, nameOverride, ignoreActionBlocker: ignoreActionBlocker, forceEmote: forceEmote);
    }
    ...
    public bool TryEmoteChatInput(EntityUid source, string textInput)
    {
