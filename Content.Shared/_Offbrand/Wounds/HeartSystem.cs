...
public sealed partial class HeartSystem : EntitySystem
{
    ...
    public float ComputeBloodVolume(Entity<HeartrateComponent> ent)
    {
        ...
        var normalMaxVolume = bloodstream.BloodReferenceSolution.Volume;

        return Math.Max(bloodSolution.Volume.Float() / normalMaxVolume.Float(), ent.Comp.MinimumBloodVolume);
    }
