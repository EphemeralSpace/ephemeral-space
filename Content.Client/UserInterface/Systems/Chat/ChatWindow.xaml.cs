...
public sealed partial class ChatWindow : FancyWindow
{
    ...
    {
        Chatbox.ChatInput.ChannelSelector.Select(ESSharedChatSystem.AdminChatChannel);

        Chatbox.ChatInput.FilterButton.Popup.SetAllActive(false);
        Chatbox.ChatInput.FilterButton.Popup.SetActive("Admin", true);
        Chatbox.ChatInput.FilterButton.Popup.SetActive("Server", true);
    }
}
