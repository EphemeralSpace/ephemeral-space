...
namespace Content.Client.Stylesheets
{
    ...
    public sealed class StyleNano : StyleBase
    {
        ...
        public static readonly Color ButtonColorDefault = Color.FromHex("#4B4B4B");
        public static readonly Color ButtonColorDefaultRed = Color.FromHex("#D43B3B");
        public static readonly Color ButtonColorHovered = Color.FromHex("#5E5E5E");
        public static readonly Color ButtonColorHoveredRed = Color.FromHex("#DF6B6B");
        public static readonly Color ButtonColorPressed = Color.FromHex("#3e6c45");
        public static readonly Color ButtonColorDisabled = Color.FromHex("#323232");
        ...
        // Fancy Tree elements
        public static readonly Color FancyTreeEvenRowColor = Color.FromHex("#262626");
        public static readonly Color FancyTreeOddRowColor = FancyTreeEvenRowColor * new Color(0.8f, 0.8f, 0.8f);
        public static readonly Color FancyTreeSelectedRowColor = new Color(56, 56, 56);
        ...
        public static readonly Color ChatBackgroundColor = Color.FromHex("#262626DD");
        ...
        public StyleNano(IResourceCache resCache) : base(resCache)
        {
            ...
            var itemListBackgroundSelected = new StyleBoxFlat { BackgroundColor = new Color(76, 76, 76) };
            ...
            var itemListItemBackground = new StyleBoxFlat { BackgroundColor = new Color(56, 56, 56) };
...
// ListContainer
                ...
                Element<ContainerButton>().Class(ListContainer.StyleClassListContainerButton)
                    .Pseudo(ContainerButton.StylePseudoClassNormal)
                    .Prop(Control.StylePropertyModulateSelf, new Color(56, 56, 56)),

                Element<ContainerButton>().Class(ListContainer.StyleClassListContainerButton)
                    .Pseudo(ContainerButton.StylePseudoClassHover)
                    .Prop(Control.StylePropertyModulateSelf, new Color(76, 76, 76)),
                ...
                Element<ContainerButton>().Class(ListContainer.StyleClassListContainerButton)
                    .Pseudo(ContainerButton.StylePseudoClassDisabled)
                    .Prop(Control.StylePropertyModulateSelf, new Color(10, 10, 10)),
                ...
                new StyleRule(new SelectorElement(typeof(ItemList), null, null, null), new[]
                {
                    new StyleProperty(ItemList.StylePropertyBackground,
                        new StyleBoxFlat {BackgroundColor = new Color(33, 33, 33)}),
                ...
                new StyleRule(new SelectorElement(typeof(Tree), null, null, null), new[]
                {
                    ...
                    {
                        BackgroundColor = new Color(56, 56, 56),
                ...
                Element<PanelContainer>().Class(OptionButton.StyleClassOptionsBackground)
                    .Prop(PanelContainer.StylePropertyPanel, new StyleBoxFlat(Color.FromHex("#262626"))),
                ...
                Element<PanelContainer>().Class("PanelBackgroundLight")
                    .Prop("panel", new StyleBoxTexture(BaseButtonOpenBoth) { Padding = default })
                    .Prop(Control.StylePropertyModulateSelf, Color.FromHex("#303030")),
