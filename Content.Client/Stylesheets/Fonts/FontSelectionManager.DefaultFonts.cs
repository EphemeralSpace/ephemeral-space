...
internal sealed partial class FontSelectionManager
{
    private static readonly FontFamilyStack DefaultFontMain = FontFamilyStack.New()
        .AddKind(FontKind.Regular, new ResPath("/Fonts/_ES/Tomorrow/Tomorrow-Regular.ttf"))
        .AddKind(FontKind.Regular, new ResPath("/Fonts/NotoSans/NotoSansSymbols-Regular.ttf"))
        .AddKind(FontKind.Bold, new ResPath("/Fonts/_ES/Tomorrow/Tomorrow-Bold.ttf"))
        .AddKind(FontKind.Bold, new ResPath("/Fonts/NotoSans/NotoSansSymbols-Bold.ttf"))
        .AddKind(FontKind.Italic, new ResPath("/Fonts/_ES/Tomorrow/Tomorrow-Italic.ttf"))
        .AddKind(FontKind.Italic, new ResPath("/Fonts/NotoSans/NotoSansSymbols-Regular.ttf"))
        .AddKind(FontKind.BoldItalic, new ResPath("/Fonts/_ES/Tomorrow/Tomorrow-BoldItalic.ttf"))
    ...
    private static readonly FontFamilyStack DefaultFontTitle = DefaultFontMain;

    private static readonly FontFamilyStack DefaultFontMachineTitle = FontFamilyStack.New()
        .AddKind(FontKind.Regular, new ResPath("/Fonts/_ES/Geo/Geo-Regular.ttf"))
        .Build();
